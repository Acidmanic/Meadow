        ...
        protected override void AddReplacements(Dictionary<string, string> replacementList)
        {
            ...
            var returnNewInsertedRecord = 
                $"DECLARE @NewId {ProcessedType.EventIdTypeName} = (IDENT_CURRENT('{ProcessedType.NameConvention.EventStreamTableName}'));" +
                                          $"\nSELECT * FROM {ProcessedType.NameConvention.EventStreamTableName} WHERE Id=@NewId;";
            
            var insertSelectStatement = ProcessedType.IsEventIdAutogenerated?returnNewInsertedRecord:
