...
public class RecordStatisticsDataProvider : ICaseDataProvider
{
    ...
    {
        var events = list.Select(i => (i as NumberEventRecord)!).ToList();
    ...
    public void Initialize()
    {
        ...
        list1.AddEvent(StreamId1,new NumberEventRecord(Guid.NewGuid(), 10));
        list1.AddEvent(StreamId1,new NumberEventRecord(Guid.NewGuid(), 20));
        list1.AddEvent(StreamId1,new NumberEventRecord(Guid.NewGuid(), 30));
        list1.AddEvent(StreamId1,new NumberEventRecord(Guid.NewGuid(), 40));
        
        var list2 = new List<object>();
        
        list2.AddEvent(StreamId2,new NumberEventRecord(Guid.NewGuid(),50));
        list2.AddEvent(StreamId2,new NumberEventRecord(Guid.NewGuid(),60));
