...
public class ClassStatisticsDataProvider : ICaseDataProvider
{
    ...
    {
        var events = list.Select(i => (i as NumberEventClass)!).ToList();
    ...
    public void Initialize()
    {
        ...
        list1.AddEvent(StreamId1,new NumberEventClass{Id = 1,Number = 10});
        list1.AddEvent(StreamId1,new NumberEventClass{Id = 2,Number = 20});
        list1.AddEvent(StreamId1,new NumberEventClass{Id = 3,Number = 30});
        list1.AddEvent(StreamId1,new NumberEventClass{Id = 4,Number = 40});
        
        var list2 = new List<object>();
        
        list2.AddEvent(StreamId2,new NumberEventClass{Id = 5,Number = 50});
        list2.AddEvent(StreamId2,new NumberEventClass{Id = 6,Number = 60});
