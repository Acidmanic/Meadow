...
public class EventStreamSnippet : ISnippet
{
    ...
    public string KeyEventIdType => Toolbox.ProcessedType.EventIdTypeName ?? string.Empty;
    public string KeyStreamIdType => Toolbox.ProcessedType.StreamIdTypeName ?? string.Empty;
    public string KeyTypeNameType => Toolbox.ProcessedType.EventStreamTypeNameDatabaseType ?? string.Empty;
    public string KeyAssemblyNameType => Toolbox.ProcessedType.EventStreamAssemblyNameDatabaseType ?? string.Empty;

    public string KeySerializedValueType =>
        Toolbox.ProcessedType.EventStreamSerializedValueDatabaseType ?? string.Empty;
    ...
    public string KeyEventIdInsertValue => Toolbox.ProcessedType.IsEventIdAutogenerated
        ? ""
        : $", {Toolbox.SqlTranslator.ProcedureBodyParameterNamePrefix}EventId";
