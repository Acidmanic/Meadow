...
public class EventStreamSnippet:ISnippet
{
    ...
    public string KeyAutogenerated => T(t => t.ProcessedType.IsEventIdAutogenerated ? "AUTOINCREMENT" : "");
    ...
    public string KeyInsertProcedureName => T(t => t.ProcessedType.IsEventIdAutogenerated ? "" : $"IN EventId {t.ProcessedType.EventIdTypeName},");
    public string KeyEventIdInsertParameter => T(t => t.ProcessedType.NameConvention.InsertEvent);
    public string KeyEventIdInsertColumn => T(t => t.ProcessedType.IsEventIdAutogenerated ? "" : ", EventId");
    public string KeyEventIdInsertValue => T(t => t.ProcessedType.IsEventIdAutogenerated ? "" : ", @EventId");
...
CREATE TABLE {KeyTableName} (
    EventId {KeyEventIdType} NOT NULL PRIMARY KEY {KeyAutogenerated},
