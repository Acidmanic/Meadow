...
namespace Meadow.SQLite.SqlScriptsGenerators
{
    ...
    public class SaveProcedureSnippetGenerator : SqLiteRepetitionHandlerProcedureGeneratorBase
    {
        ...
        private record SaveProcedureAnalysis(string ProcedureName, List<Parameter> WhereEqualities, List<Parameter> InsertUpdateParameters);
            ...
            params FieldKey[] identifierFields)
        {
            ...
            var analysis = CreateSaveProcedureAnalysis(collectionName, identifierFields);
        ...
        private SaveProcedureAnalysis CreateSaveProcedureAnalysis(string collectionName, params FieldKey[] identifierFields)
        {
            ...
            return new SaveProcedureAnalysis(ProcessedType.SaveProcedureNames[collectionName], identifierParameters, nonAutoGeneratedParameters);
        }
