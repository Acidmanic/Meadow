...
namespace Meadow.Postgre.Scaffolding
{
    ...
    public class EventStreamCodeGenerator : ByTemplateSqlGeneratorBase
    {
        ...
        protected override void AddReplacements(Dictionary<string, string> replacementList)
        {
            ...
            replacementList.Add(_keyReadAllStreamsProcedureName,ProcessedType.NameConvention.ReadAllStreams.DoubleQuot());
            
            replacementList.Add(_keyReadStreamsByStreamIdProcedureName,ProcessedType.NameConvention.ReadStreamByStreamId.DoubleQuot());
            
            replacementList.Add(_keyEventIdTypeName,ProcessedType.EventIdTypeName);
            
            replacementList.Add(_keyReadAllStreamsChunkProcedureName,ProcessedType.NameConvention.ReadAllStreamsChunks.DoubleQuot());
            
            replacementList.Add(_keyReadStreamChunkByStreamIdProcedureName,ProcessedType.NameConvention.ReadStreamChunkByStreamId.DoubleQuot());
        }
