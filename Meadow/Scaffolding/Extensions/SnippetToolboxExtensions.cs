...
public static class SnippetToolboxExtensions
{
    ...
    public static string WhereByIdClause(this ISnippetToolbox toolbox, bool actById, bool fullTree)
    {
        ...
        var pt = qt.QuoteParameterDefinitionName;

        var procedureParameter = procedureIdParameter?.Name;

        if (toolbox.SqlTranslator.ProcedureParameterNamePrefixBeforeQuoting)
        {
            procedureParameter = pt(toolbox.SqlTranslator.ProcedureBodyParameterNamePrefix + procedureParameter);
        }
        else
        {
            procedureParameter = toolbox.SqlTranslator.ProcedureBodyParameterNamePrefix +
                                 pt(procedureParameter ?? string.Empty);
        }
