...
public static class SnippetToolboxExtensions
{
    ...
    public static Parameter[] GetValueParameters(this ISnippetToolbox toolbox) => toolbox.ProcessedType.Parameters.Where(p =>
    ...
    public static string EqualityClause(this ISnippetToolbox toolbox, string? sourceName = null, bool fullTree=false, params Parameter[] parameters)
    {
