...
public abstract class ViewBase<TModel>
{
    ...
    protected IQuerySource<TParametersModel,TModel, TProperty> IncludeWithParameters<TParametersModel,TProperty>(FieldKey includedField)
    {
    ...
    //
    // protected IQuerySource<TModel, TProperty> IncludeWithoutParameters<TProperty>(
...
{
    public IQuerySource<TParametersModel, TModel, TProperty> Include<TProperty>(Expression<Func<TModel, TProperty>> select)
    {
        var fieldKey = MemberOwnerUtilities.GetKey(select);
    ...
    public IQuerySource<TParametersModel,TModel, TProperty> Include<TProperty>(Expression<Func<TModel, List<TProperty>>> select)
    {
        var fieldKey = MemberOwnerUtilities.GetKey(select);
